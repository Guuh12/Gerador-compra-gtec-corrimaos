...
async function generatePdf(input) {
    ...
    const drawHeader = ()=>{
        ...
        // Curva esquerda (cinza escuro)
        doc.setFillColor(55, 55, 55);
        doc.ellipse(27.5, 27.5, 8, 8, 45, 0, 180, 'F');
        // Curva direita (vermelha)
    ...
    const drawText = (text, x, startY, options = {})=>{
    ...
    doc.setFont('helvetica', 'bold');
    doc.setTextColor(primaryColor);
    drawText('Dados do Cliente:', pageMargin, y);
    doc.setFontSize(12);
    doc.setFont('helvetica', 'normal');
    doc.setTextColor(textColor);
    drawText(`Nome: ${input.name}`, pageMargin, y);
    drawText(`Endereço: ${input.street}`, pageMargin, y);
    drawText(`CEP: ${input.zipCode}`, pageMargin, y);
    drawText(`Telefone: ${input.phoneNumber}`, pageMargin, y);
    y += 10;
    ...
    doc.setFont('helvetica', 'bold');
    doc.setTextColor(primaryColor);
    drawText('Detalhes do Pedido:', pageMargin, y);
    // Table Header
    checkPageBreak(15);
    ...
    itemDescLines.forEach((line, index)=>{
        checkPageBreak(lineHeight);
    ...
    doc.setFont('helvetica', 'bold');
    doc.setTextColor(primaryColor);
    drawText('Prazo de Entrega:', pageMargin, y);
    doc.setFontSize(11);
    doc.setFont('helvetica', 'normal');
    doc.setTextColor(textColor);
    drawText("até 25 dias úteis, com aviso prévio de 1 dia para a montagem, a partir das 8h30, de segunda a sexta-feira.  \nObs: Não trabalhamos aos finais de semana (sábado e domingo) nem em feriados.", pageMargin, y, {
        maxWidth: 180
    });
    y += 5;
    // Additional Notes
    if (input.additionalNotes) {
        ...
        doc.setFont('helvetica', 'bold');
        doc.setTextColor(primaryColor);
        drawText('Observações Adicionais:', pageMargin, y);
        doc.setFontSize(12);
        doc.setFont('helvetica', 'normal');
        doc.setTextColor(textColor);
        drawText(input.additionalNotes, pageMargin, y, {
            maxWidth: 180
        });
        y += 5;
    }
    ...
    doc.setTextColor(textColor);
    drawText("Obs. As visitas comerciais devem ser agendadas.", 105, y, {
        maxWidth: doc.internal.pageSize.width - 105,
        align: 'center'
    });
    y += 7;
    doc.setFont('helvetica', 'bold');
    drawText("Agradecemos sua preferência.", 105, y, {
        maxWidth: doc.internal.pageSize.width - 105,
        align: 'center'
    });
    y += 7;
    doc.setFont('helvetica', 'normal');
    drawText("Depto. Comercial", 105, y, {
        maxWidth: doc.internal.pageSize.width - 105,
        align: 'center'
    });
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "relative w-20 h-20 bg-black rounded-lg flex items-center justify-center overflow-hidden",
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "absolute left-0 bottom-0 w-12 h-12 border-l-4 border-b-4 border-gray-700 rounded-bl-full transform rotate-45 origin-bottom-left"
                            }, void 0, false, {
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "absolute right-0 top-0 w-12 h-12 border-r-4 border-t-4 border-red-600 rounded-tr-full transform -rotate-45 origin-top-right"
                            }, void 0, false, {
                                fileName: "[project]/src/app/page.tsx",
                                lineNumber: 16,
                                columnNumber: 13
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8c23d0cf._.js.map